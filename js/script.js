$(document).ready(function(){
  // Initialize Firebase
  var config = {
      apiKey: "AIzaSyDteJ_QZL-PlvIFYCavbhjSXPG6VlTPlO8",
      authDomain: "hello-6a070.firebaseapp.com",
      databaseURL: "https://hello-6a070.firebaseio.com",
      storageBucket: "hello-6a070.appspot.com",
      messagingSenderId: "997250554100"
    };
  ...
  firebase.auth().onAuthStateChanged(function(user){
    ...
    dbUserid.once('child_added',function(snapshot){
          ...
          $profileOccupation.html(data.occupation);
          $profileDescription.html(data.description);
    });
  ...
  $btnSubmit.click(function(){
    ...
    promise.then(function() {
      ...
      if(useroccupation!="")dbUserid.child("data").update({occupation:useroccupation});
      if(userdescription!="")dbUserid.child("data").update({description:userdescription});
